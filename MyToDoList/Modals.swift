...
struct ToDoList {
    ...
    init(todo: String, isDone: Bool, expired: String, imagePath: String = "", videoPath: String = "") {
...
func fakeData() -> [ToDoList] {
    let todo1 = ToDoList(todo: "Ngừng lo lắng về tiền bạc, Dùng tiền để có thêm nhiều trải nghiệm hơn là dành dụm cho những lúc khó khăn, Dành thời gian cho gia đình và bạn bè, Dành thời gian chơi với trẻ nhỏ, ngay cả khi chúng không phải là con bạn", isDone: false, expired: "20/11/2022")
    let todo2 = ToDoList(todo: "Ngừng lo lắng về suy nghĩ của người khác, Nếm thử tất cả các món ăn, Chơi những môn thể thao gây cảm giác mạnh như nhảy dù hoặc nhảy bungee", isDone: true, expired: "20/11/2022")
    let todo3 = ToDoList(todo: "Đi nghỉ 2 lần mỗi năm, Tìm kiếm tình yêu đích thực, Lên kế hoạch cho một bữa tiệc bất ngờ", isDone: false, expired: "20/11/2022")
